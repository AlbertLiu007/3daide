...
import type { ViewerLabels } from '@/lib/i18n/dictionaries';
...
export function ThreeModelViewerClient({ object, color = '#d9eef5', labels }: { object: THREE.Object3D | null; color?: string; labels: ViewerLabels }) {
  ...
  useEffect(() => {
    ...
    scene.add(new THREE.HemisphereLight(0xf5fbff, 0x334155, 0.82));
      ...
      const grid = new THREE.GridHelper(180, 12, 0x334155, 0x1f2937);
    grid.position.y = -68;
